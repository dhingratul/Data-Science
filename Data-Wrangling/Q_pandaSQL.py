...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 23 13:08:50 2017
...
def select_first_50(filename):
    ...
    # Afterwards, we rename the columns
    # by replacing spaces with underscores and setting all characters to
    # lowercase, so the column names more closely resemble columns names one
    ...
    # of the select does matter. Make sure you select registrar then enrolment
